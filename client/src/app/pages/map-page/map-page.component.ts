...
handleKeyDown(event: KeyboardEvent) {
  ...
  createMap() {
    ...
    L ${this.fabricCanvas.width as number / 6} ${this.fabricCanvas.height as number - 10}
    L ${(this.fabricCanvas.width as number * 5) / 6} ${this.fabricCanvas.height as number - 10}
    L ${this.fabricCanvas.width as number - 10} ${(this.fabricCanvas.height as number * 4) / 5}
    L ${this.fabricCanvas.width as number - 10} ${(this.fabricCanvas.height as number * 3) / 5}
    L ${this.fabricCanvas.width as number} ${(this.fabricCanvas.height as number * 3) / 5}
    L ${this.fabricCanvas.width as number} ${(this.fabricCanvas.height as number * 2) / 5}
    L ${this.fabricCanvas.width as number - 10} ${(this.fabricCanvas.height as number * 2) / 5}
    L ${this.fabricCanvas.width as number - 10} ${this.fabricCanvas.height as number / 5}
  ...
  private setUpCanvas() {
    ...
    const parentDiv = canvasEl.parentElement ? canvasEl.parentElement : canvasEl;
